...
import { getInboxItemsController, updateItemController, getPagesController, duplicateItemController, createPageController } from "./item.controller";
...
router.post("/:workspaceId/item/page", authMiddleware, workspaceMemberMiddleware, createPageController);
